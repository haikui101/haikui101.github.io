...
export default class GuiMainMenu extends GuiScreen {
    ...
    constructor() {
        ...
        this.splashText = "Fuck, It's Monday :<";
    }
    ...
    init() {
        ...
        this.buttonList.push(new GuiButton("GuyPank Hamatok!", this.width / 2 - 100, y + 24 * 2, 200, 20, () => {
        ...
        this.buttonList.push(new GuiButton("Rage Quit", this.width / 2 + 2, y + 72 + 12, 98, 20, () => {
            this.minecraft.stop();
        }));
    ...
    drawScreen(stack, mouseX, mouseY, partialTicks) {
        ...
        this.drawRightString(stack, "GitHub @Haikui101/js-minecraft", this.width - 2, this.height - 10, mouseOver ? 0xFF00FFFF : 0xFFFFFFff);
